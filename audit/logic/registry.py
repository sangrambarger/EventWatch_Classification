...
MODULES: dict[str, str] = {
    ...
    "Business Spin-off": "business_spinoff",
    "Company Split": "company_split",
    "Corporate Restructuring": "corporate_restructuring",
    "Cyber Attack": "cyber_attack",
    "Factory Fire": "factory_fire",
    "Factory Disruption": "factory_disruption",
    ...
    "Financial Distress": "financial_distress",
    "Profit Warning": "profit_warning",
    "Fine": "fine",
    "Price Fluctuation": "price_fluctuation",
    "Compliance": "compliance",
    "FDA/EMA/OSHA Action": "fda_ema_osha_action",
    "Regulatory Change": "regulatory_change",
    "Counterfeit (CFSI)": "counterfeit",
    "Recall": "recall",
    "Legal Action": "legal_action",
    "Bribery/Corruption": "bribery_corruption",
    "Labor Violation": "labor_violation",
    "Force Majeure": "force_majeure",
    "Supply Shortage": "supply_shortage",
    "Mine Shutdown": "mine_shutdown",
    "Airport Disruption": "airport_disruption",
    "Port Disruption": "port_disruption",
    "Labor Disruption": "labor_disruption",
    "Geopolitical": "geopolitical",
    "Protest/Riot": "protest_riot",
    "Environmental Hazard": "environmental_hazard",
    "Extreme Weather": "extreme_weather",
    "Flood": "flood",
    "Forest Fire": "forest_fire",
    "Human Health": "human_health",
    "Hurricane/Typhoon (Pre-Landfall)": "hurricane_pre_landfall",
    "Hurricane/Typhoon (Post-Landfall)": "hurricane_post_landfall",
    "Tornado": "tornado",
    "Volcano": "volcano",
}
